...
/* function game(){
    for(let i = 0; i < 5; i++){
        plSelect = prompt('Rock, Paper or Scissors?');
        cpSelect = computerPlay();
        playRound(plSelect, cpSelect);
...
function showResult(computerSelection, roundResult){
    resultDiv.innerHTML = '<br>Computer chose: ' +computerSelection+ '<br>' + roundResult + '<br><br>Player score: '+playerScore + '<br>' + 'Computer score: '+computerScore;
